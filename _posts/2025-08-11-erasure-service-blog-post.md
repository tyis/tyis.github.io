...
東洋インターネットサービス株式会社（TOYO）の皆様、そして日頃より弊社サービスをご利用いただいているお客様へ。
...
![TOYO Data Erasure Service Flow]({{ site.url }}/assets/images/posts/2025-08-11/erasure-service-flow.svg)
